...
SRCS	:= 	$(SRC_DIR)/main.c $(SRC_DIR)/parsing/initialise.c $(SRC_DIR)/error_handling/free.c $(SRC_DIR)/error_handling/error.c \
			...
			$(SRC_DIR)/parsing/heredoc.c $(SRC_DIR)/parsing/heredoc_syntax.c $(SRC_DIR)/parsing/quotes_two.c $(SRC_DIR)/parsing/expand_env_two.c\
			...
			$(SRC_DIR)/parsing/heredoc_utils.c $(SRC_DIR)/debug.c
